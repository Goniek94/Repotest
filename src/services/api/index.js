...
export default {
  ...
  sendMessageToAd: (adId, data) => apiClient.post(`/messages/send-to-ad/${adId}`, data).then(r => r.data),
  sendMessageToUser: (userId, data) => apiClient.post(`/messages/send-to-user/${userId}`, data).then(r => r.data),
  replyToMessage: (msgId, data) => apiClient.post(`/messages/reply/${msgId}`, data).then(r => r.data),
  ...
  getConversationsList: () => apiClient.get('/messages/conversations').then(r => r.data),
  getConversation: (userId) => apiClient.get(`/messages/conversation/${userId}`).then(r => r.data),
