...
const ListingTabs = ({ activeTab, setActiveTab, counts = {} }) => (
  <div className="mb-6 bg-white p-3 sm:p-4 border border-gray-200" style={{ borderRadius: '2px' }}>
    <div className="flex flex-wrap gap-2">
      <button
        onClick={() => setActiveTab("active")}
        className={`py-2 sm:py-3 px-3 sm:px-6 font-medium text-sm sm:text-base transition-colors ${
          activeTab === "active"
      ...
      <button
        ...
        className={`py-2 sm:py-3 px-3 sm:px-6 font-medium text-sm sm:text-base transition-colors flex items-center ${
          activeTab === "drafts"
            ? "bg-[#35530A] text-white"
            : "bg-white text-gray-700 border border-gray-200 hover:bg-gray-50"
        }`}
